  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative rounded-md border border-slate-200 bg-white p-5 shadow-lg shadow-black/10"
      >
        ...
        <div className="mt-2 h-1.5 w-full overflow-hidden rounded-sm bg-slate-100">
          <motion.div
            className="h-1.5 rounded-sm bg-brand-600"
            initial={{ width: "0%" }}
            animate={{ width: "92%" }}
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          {STATS.map((stat, i) => (
            <motion.div
              ...
              className="rounded-sm border border-slate-100 bg-slate-50 p-2.5 text-center"
            >
              <AnimatedCounter
                value={stat.value}
                duration={0.9}
        ...
        <motion.div
          ...
          className="mt-4 rounded-sm border border-slate-200 p-4"
        >
          <div className="flex items-center justify-between">
          ...
          <span className="mt-3 inline-block rounded-sm bg-brand-600 px-3 py-1.5 text-xs font-semibold text-white">
            View Job
          </span>
        </motion.div>
      </motion.div>
